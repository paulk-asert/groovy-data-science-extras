...
def base1 = '/home/paulk/projects/groovy-data-science/subprojects/MNIST' as File
def base2 = '/home/paulk/projects/wekaDeeplearning4j' as File
def data = new Instances(new FileReader("$base1/src/main/resources/mnist.meta.minimal.arff"))
data.classIndex = data.numAttributes() - 1

// Populate the image iterator
def imgIter = new ImageInstanceIterator(imagesLocation: "$base2/datasets/nominal/mnist-minimal" as File,
        height: 28, width: 28, numChannels: 1, trainBatchSize: 4)

def clf = new Dl4jMlpClassifier(seed: 1, numEpochs: 80, instanceIterator: imgIter)
